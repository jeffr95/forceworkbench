...
<form>
  ...
  <h4>MJ Bean Projects</h4>                                 
      ...
      <tr>
        ...
        <td><input type="button" value="Login" onclick="window.href.location='https://relationedgeatlantaworkbench.herokuapp.com/login.php?un=m_bean@trailhead.com&pw=&atl='"/>     Trailhead Prod</td>
      </tr>
  </table>
</form>
